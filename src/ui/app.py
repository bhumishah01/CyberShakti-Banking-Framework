...
def _bundle(lang: str) -> dict:
    bundles = {
        "en": {
            ...
            "voice_record": "Record",
            "voice_stop": "Stop",
            "voice_listening": "Listening… speak your command now.",
            "voice_not_supported": "Voice recording is not supported in this browser. Use Chrome, or type the command.",
            "voice_mic_denied": "Microphone permission denied. Allow microphone access and try again.",
            "voice_record_failed": "Could not start voice recording. Try again or type the command.",
            ...
            "demo_map_intro": "Use this as a script during your evaluation. It maps every required feature to the exact dashboard panel and API endpoint.",
            "demo_map_urls_title": "URLs",
            "demo_map_login": "Login URL",
            "demo_map_dashboard": "Dashboard URL (after login)",
            "demo_map_analytics": "Analytics URL",
            "demo_map_core_title": "Core Intelligence (Must Have)",
            "demo_map_item1": "1) Adaptive Risk Score (Admin View)",
            "demo_map_item1_where": "See risk_score + risk_level in Transaction Monitoring (Local), and user_risk_score in High-Risk Users.",
            "demo_map_item2": "2) Behavior Profiling (Admin Insights)",
            "demo_map_item2_where": "High-Risk Users table shows avg_amount, tx_count, last activity, peak hours.",
            "demo_map_item3": "3) Explainable Fraud Engine (Why risky)",
            "demo_map_item3_where": "Transaction Monitoring (Local) shows reason_codes (e.g., NEW_DEVICE, HIGH_AMOUNT, ODD_HOUR).",
            "demo_map_alerts_title": "Monitoring & Alerts",
            "demo_map_item4": "4) Suspicious Pattern Alerts",
            "demo_map_item4_where": "Suspicious Pattern Alerts panel (rapid transactions, failed logins, repeated high risk).",
            "demo_map_item5": "5) Notification / Alert Panel",
            "demo_map_item5_where": "Admin Notifications list.",
            "demo_map_intel_title": "Admin Dashboard Intelligence",
            "demo_map_item6": "6) Fraud Trends Dashboard",
            "demo_map_item6_where": "Fraud Trends (Local) table (by day + top types).",
            "demo_map_item7": "7) High-Risk Users List",
            "demo_map_item7_where": "High-Risk Users table (sorted by user_risk_score).",
            "demo_map_item8": "8) Device Monitoring",
            "demo_map_item8_where": "Device Monitoring table (trusted/untrusted, first/last seen).",
            "demo_map_controls_title": "Control Features",
            "demo_map_item9": "9) Transaction Monitoring + Actions",
            "demo_map_item9_where": "Approve/Reject appears for HELD transactions in Transaction Monitoring (Local).",
            "demo_map_item10": "10) User Risk Control (Freeze/Unfreeze)",
            "demo_map_item10_where": "High-Risk Users > User Controls (Freeze 60m / Unfreeze).",
            "demo_map_bonus_title": "Bonus (Already Implemented)",
            "demo_map_item11": "11) Risk Distribution Summary",
            "demo_map_item11_where": "Admin Overview section (Low/Medium/High bars).",
            ...
            "safety_label_healthy": "Healthy",
            "safety_label_watchlist": "Watchlist",
            "safety_label_high_risk": "High Risk",
        ...
        "hi": {
            ...
            "safety_score_hint": "पिछले 24 घंटे की गतिविधि पर आधारित स्वास्थ्य संकेतक।",
            "safety_score_breakdown": "अलर्ट / होल्ड / ब्लॉक्ड:",
            "safety_label_healthy": "ठीक",
            "safety_label_watchlist": "नज़र रखें",
            "safety_label_high_risk": "उच्च जोखिम",
            "offline_sim_title": "ऑफलाइन सिम्युलेटर",
            "offline_on": "ऑफलाइन चालू",
            "offline_off": "ऑनलाइन",
            "offline_sim_hint": "चालू होने पर सिंक ऐसा करेगा जैसे इंटरनेट नहीं है (ऑफलाइन‑प्रथम डेमो)।",
            "turn_on": "चालू करें",
            "turn_off": "बंद करें",
            ...
            "admin_portal_subtitle": "फ्रॉड समीक्षा, सिंक निगरानी और ऑडिट दृश्यता के लिए केंद्रीय नियंत्रण।",
            "page_title_analytics": "एडमिन एनालिटिक्स - RuralShield",
            "logout": "लॉगआउट",
            "nav_monitoring": "निगरानी",
            "nav_operations": "ऑपरेशन्स",
            "nav_admin": "प्रशासन",
            "nav_tools": "टूल्स",
            "analytics_button": "एनालिटिक्स",
            "analytics_title": "एनालिटिक्स डैशबोर्ड",
            "analytics_subtitle": "एक जगह पर सभी मॉनिटरिंग सिग्नल: जोखिम स्कोर, व्यवहार प्रोफाइलिंग, अलर्ट, डिवाइस और ट्रेंड।",
            "analytics_graph_aria": "फ्रॉड ट्रेंड ग्राफ",
        },
        "or": {
            "lang_label": "ଭାଷା",
            "language_label": "ଭାଷା",
            ...
            "safety_score_hint": "ଗତ 24 ଘଣ୍ଟାର କାର୍ଯ୍ୟକଳାପ ଉପରେ ଆଧାରିତ ସ୍ୱାସ୍ଥ୍ୟ ସୂଚକ।",
            "safety_score_breakdown": "ଅଲର୍ଟ / ହୋଲ୍ଡ / ବ୍ଲକ୍ଡ:",
            "safety_label_healthy": "ଠିକ୍",
            "safety_label_watchlist": "ନଜର ରଖନ୍ତୁ",
            "safety_label_high_risk": "ଉଚ୍ଚ ଝୁମ୍ପ",
            "offline_sim_title": "ଅଫଲାଇନ ସିମୁଲେଟର୍",
            "offline_on": "ଅଫଲାଇନ ଅନ୍",
            "offline_off": "ଅନଲାଇନ୍",
            "offline_sim_hint": "ଅନ୍ ହେଲେ ସିଙ୍କ ଇଣ୍ଟରନେଟ୍ ନଥିବା ପରି କାମ କରିବ (ଅଫଲାଇନ-ପ୍ରଥମ ଡେମୋ)।",
            "turn_on": "ଅନ୍ କରନ୍ତୁ",
            "turn_off": "ଅଫ୍ କରନ୍ତୁ",
            ...
            "admin_portal_subtitle": "ଠକେଇ ସମୀକ୍ଷା, ସିଙ୍କ ମନିଟରିଂ ଏବଂ ଅଡିଟ୍ ଦୃଶ୍ୟତା ପାଇଁ କେନ୍ଦ୍ରୀୟ ନିୟନ୍ତ୍ରଣ।",
            "logout": "ଲଗ୍ ଆଉଟ୍",
            "nav_monitoring": "ମନିଟରିଂ",
            "nav_operations": "ଅପରେସନ୍",
            "nav_admin": "ପ୍ରଶାସନ",
            "nav_tools": "ଟୁଲ୍ସ",
            "analytics_button": "ଏନାଲିଟିକ୍ସ",
            "page_title_analytics": "ଏଡମିନ ଏନାଲିଟିକ୍ସ - RuralShield",
            "analytics_title": "ଏନାଲିଟିକ୍ସ ଡ୍ୟାଶବୋର୍ଡ",
            "analytics_subtitle": "ଏକ ସ୍ଥାନରେ ସମସ୍ତ ମନିଟରିଂ ସିଗ୍ନାଲ୍: ଝୁମ୍ପ ସ୍କୋର୍, ବ୍ୟବହାର ପ୍ରୋଫାଇଲିଂ, ଅଲର୍ଟ, ଡିଭାଇସ୍ ଏବଂ ଟ୍ରେଣ୍ଡ।",
            "analytics_graph_aria": "ଫ୍ରଡ୍ ଟ୍ରେଣ୍ଡ ଗ୍ରାଫ୍",
        },
        "gu": {
            "lang_label": "ભાષા",
            "language_label": "ભાષા",
            ...
            "safety_score_hint": "છેલ્લા 24 કલાકની પ્રવૃત્તિ પરથી સરળ હેલ્થ ગેજ.",
            "safety_score_breakdown": "એલર્ટ / હોલ્ડ / બ્લોક્ડ:",
            "safety_label_healthy": "સારો",
            "safety_label_watchlist": "નજર રાખો",
            "safety_label_high_risk": "ઉચ્ચ જોખમ",
            "offline_sim_title": "ઓફલાઇન સિમ્યુલેટર",
            "offline_on": "ઓફલાઇન ON",
            "offline_off": "ઓનલાઇન",
            "offline_sim_hint": "ON હોય ત્યારે સિંક એવું વર્તે છે જેમ કે ઇન્ટરનેટ નથી (ઓફલાઇન-ફર્સ્ટ ડેમો).",
            "turn_on": "ON કરો",
            "turn_off": "OFF કરો",
            ...
            "admin_portal_subtitle": "ફ્રોડ રિવ્યુ, સિંક મોનિટરિંગ અને ઓડિટ વિઝિબિલિટી માટે કેન્દ્રિય કંટ્રોલ્સ.",
            "logout": "લૉગઆઉટ",
            "nav_monitoring": "મોનિટરિંગ",
            "nav_operations": "ઓપરેશન્સ",
            "nav_admin": "એડમિન",
            "nav_tools": "ટૂલ્સ",
            "analytics_button": "એનાલિટિક્સ",
            "page_title_analytics": "એડમિન એનાલિટિક્સ - RuralShield",
            "analytics_title": "એનાલિટિક્સ ડેશબોર્ડ",
            "analytics_subtitle": "એક જ જગ્યાએ બધા મોનિટરિંગ સિગ્નલ્સ: રિસ્ક સ્કોર, બેહેવિયર પ્રોફાઇલિંગ, એલર્ટ, ડિવાઇસ અને ટ્રેન્ડ્સ.",
            "analytics_graph_aria": "ફ્રોડ ટ્રેન્ડ ગ્રાફ",
        },
        "de": {
            "lang_label": "Sprache",
            ...
            "safety_score_hint": "Einfacher Gesundheitsindikator basierend auf den letzten 24 Stunden.",
            "safety_score_breakdown": "Alerts / Held / Blocked:",
            "safety_label_healthy": "Stabil",
            "safety_label_watchlist": "Beobachten",
            "safety_label_high_risk": "Hohes Risiko",
            "offline_sim_title": "Offline-Simulator",
            "offline_on": "Offline AN",
            "offline_off": "Online",
            "offline_sim_hint": "Wenn AN, verhält sich Sync so, als gäbe es kein Internet (Offline-First-Demo).",
            "turn_on": "AN",
            "turn_off": "AUS",
            ...
            "admin_portal_subtitle": "Zentrale Steuerung für Betrugsprüfung, Sync-Monitoring und Audit-Transparenz.",
            "logout": "Abmelden",
            "page_title_analytics": "Admin-Analytik - RuralShield",
            "nav_monitoring": "Ueberwachung",
            "nav_operations": "Betrieb",
            "nav_admin": "Administration",
            "nav_tools": "Werkzeuge",
            "analytics_button": "Analytik",
            "analytics_title": "Analytik-Dashboard",
            "analytics_subtitle": "Alle Monitoring-Signale an einem Ort: Risikoscores, Verhaltensprofil, Warnungen, Geraete und Trends.",
            "analytics_graph_aria": "Betrugstrend-Grafik",
        },
    }
    base = bundles["en"]
...
def _t(lang: str, key: str) -> str:
    ...
    dictionary = {
        ...
        "hi": {
            ...
            "voice_record": "रिकॉर्ड",
            "voice_stop": "रोकें",
            "voice_listening": "सुन रहा है… अब कमांड बोलें।",
            "voice_not_supported": "इस ब्राउज़र में वॉइस रिकॉर्डिंग सपोर्ट नहीं है। Chrome उपयोग करें या कमांड टाइप करें।",
            "voice_mic_denied": "माइक्रोफोन की अनुमति नहीं मिली। अनुमति दें और फिर कोशिश करें।",
            "voice_record_failed": "वॉइस रिकॉर्डिंग शुरू नहीं हो पाई। फिर कोशिश करें या टाइप करें।",
        ...
        "or": {
            ...
            "voice_record": "ରେକର୍ଡ",
            "voice_stop": "ବନ୍ଦ",
            "voice_listening": "ଶୁଣୁଛି… ବର୍ତ୍ତମାନ କମାଣ୍ଡ କହନ୍ତୁ।",
            "voice_not_supported": "ଏହି ବ୍ରାଉଜରରେ ଭଏସ୍ ରେକର୍ଡ ସପୋର୍ଟ ନାହିଁ। Chrome ବ୍ୟବହାର କରନ୍ତୁ କିମ୍ବା ଟାଇପ୍ କରନ୍ତୁ।",
            "voice_mic_denied": "ମାଇକ୍ ଅନୁମତି ମିଳିଲା ନାହିଁ। ଅନୁମତି ଦିଅନ୍ତୁ ଏବଂ ପୁଣି ଚେଷ୍ଟା କରନ୍ତୁ।",
            "voice_record_failed": "ଭଏସ୍ ରେକର୍ଡ ଆରମ୍ଭ ହେଲା ନାହିଁ। ପୁଣି ଚେଷ୍ଟା କରନ୍ତୁ କିମ୍ବା ଟାଇପ୍ କରନ୍ତୁ।",
        ...
        "gu": {
            ...
            "voice_record": "રેકોર્ડ",
            "voice_stop": "બંધ",
            "voice_listening": "સાંભળી રહ્યું છે… હવે કમાન્ડ બોલો.",
            "voice_not_supported": "આ બ્રાઉઝરમાં વૉઇસ રેકોર્ડિંગ સપોર્ટ નથી. Chrome વાપરો અથવા કમાન્ડ ટાઇપ કરો.",
            "voice_mic_denied": "માઇક્રોફોન પરમિશન મળ્યું નથી. પરમિશન આપો અને ફરી પ્રયત્ન કરો.",
            "voice_record_failed": "વૉઇસ રેકોર્ડિંગ શરૂ ન થયું. ફરી પ્રયત્ન કરો અથવા ટાઇપ કરો.",
        ...
        "de": {
            ...
            "voice_record": "Aufnehmen",
            "voice_stop": "Stopp",
            "voice_listening": "Hoere zu… sprich jetzt deinen Befehl.",
            "voice_not_supported": "Sprachaufnahme wird in diesem Browser nicht unterstuetzt. Bitte Chrome nutzen oder den Text tippen.",
            "voice_mic_denied": "Mikrofon-Berechtigung verweigert. Bitte erlauben und erneut versuchen.",
            "voice_record_failed": "Sprachaufnahme konnte nicht gestartet werden. Erneut versuchen oder Text tippen.",
